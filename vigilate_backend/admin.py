...
class MyUserAdmin(UserAdmin):
    list_display = ('id', 'email', 'plan', 'last_login', 'phone', 'user_type', 'contrat', 'id_dealer', 'is_superuser', 'default_alert_type')
    list_search = ('id', 'email', 'plan', 'last_login', 'phone', 'user_type', 'contrat', 'id_dealer', 'is_superuser', 'default_alert_type')
    filter_horizontal = ()
    ordering = ('id', 'email')
    list_filter = ('id', 'email', 'plan', 'last_login', 'phone', 'user_type', 'contrat', 'id_dealer', 'is_superuser', 'default_alert_type')
    fieldsets = (
        ...
        ('Other detials', {'fields': ('user_type', 'contrat', 'id_dealer', 'plan')}),
    )
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
